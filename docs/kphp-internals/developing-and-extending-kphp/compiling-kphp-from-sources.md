...
apt install git cmake-data=3.16* cmake=3.16* make g++ gperf python3-minimal python3-jsonschema \
            ...
            libzstd-dev libyaml-cpp-dev libnghttp2-dev zlib1g-dev php7.4-dev libmysqlclient-dev libpq-dev libnuma-dev
```
...
```bash
brew install re2c cmake coreutils glib-openssl libiconv re2 yaml-cpp mysql postgresql@14 msgpack-cxx zstd googletest php@7.4
brew link --overwrite php@7.4
pip3 install jsonschema
ln -sF /usr/local/include/postgresql@14 /usr/local/include/postgresql
```
